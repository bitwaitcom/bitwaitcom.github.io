...
public class OrderController {
    ...
    public MessageResult current(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember authMember,
                                   String symbol, // 交易对符号
                                   Long optionId // 参与对象
    ) {
    ...
    public MessageResult history(@SessionAttribute(SysConstant.SESSION_MEMBER) AuthMember authMember,
