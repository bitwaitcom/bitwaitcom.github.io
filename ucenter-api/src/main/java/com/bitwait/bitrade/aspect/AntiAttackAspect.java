...
public class AntiAttackAspect {
    ...
    @Pointcut("execution(public * com.bitwait.bitrade.controller.RegisterController.sendBindEmail(..))" +
            "||execution(public * com.bitwait.bitrade.controller.RegisterController.sendAddAddress(..))" +
            "||execution(public * com.bitwait.bitrade.controller.SmsController.sendResetTransactionCode(..))" +
            "||execution(public * com.bitwait.bitrade.controller.SmsController.setBindPhoneCode(..))" +
            "||execution(public * com.bitwait.bitrade.controller.SmsController.updatePasswordCode(..))" +
            "||execution(public * com.bitwait.bitrade.controller.SmsController.addAddressCode(..))" +
            "||execution(public * com.bitwait.bitrade.controller.SmsController.resetPhoneCode(..))")
