...
import com.bitwait.bitrade.exception.GeeTestException;
...
public class GeeTestAspect {
 ...
 // "||execution(public * SmsController.resetPasswordCode(..))"+
    @Pointcut("execution(public * com.bitwait.bitrade.controller.RegisterController.registerByEmail(..))"+
            "||execution(public * com.bitwait.bitrade.controller.RegisterController.sendResetPasswordCode(..))")
    public void geeTest() {

    }
    @Pointcut("execution(public * com.bitwait.bitrade.controller.SmsController.sendCheckCode(..))" +
            "||execution(public * com.bitwait.bitrade.controller.RegisterController.sendRegEmail(..))")
