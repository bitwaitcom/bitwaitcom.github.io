...
import static com.bitwait.bitrade.util.MessageResult.error;
import static com.bitwait.bitrade.util.MessageResult.success;
...
import com.bitwait.bitrade.event.MemberEvent;
import com.bitwait.bitrade.service.CoinService;
import com.bitwait.bitrade.service.CountryService;
import com.bitwait.bitrade.service.LocaleMessageSourceService;
import com.bitwait.bitrade.service.MemberPromotionService;
...
import com.bitwait.bitrade.service.RedEnvelopeDetailService;
import com.bitwait.bitrade.service.RedEnvelopeService;
import com.bitwait.bitrade.util.BigDecimalUtils;
import com.bitwait.bitrade.util.DateUtil;
import com.bitwait.bitrade.util.GeneratorUtil;
import com.bitwait.bitrade.util.IdWorkByTwitter;
import com.bitwait.bitrade.util.Md5;
import com.bitwait.bitrade.util.MessageResult;
import com.bitwait.bitrade.util.ValidateUtil;
...
public class RedEnvelopeController extends BaseController{
    ...
    private MessageResult receiveEnvelope(String phone, String verifyCode, String promotionCode,
    	...
    	if(!memberService.phoneIsExist(phone)) {
	        ...
	        member1.setAvatar("https://bitwait.oss-cn-hangzhou.aliyuncs.com/defaultavatar.png");
